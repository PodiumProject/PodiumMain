...
$options['general_settings']['SUB']['general_settings']['admin_bar'] = array(
												'label' =>__('Hide Admin Bar', THEME_NAME),
												'type' =>'switch',
												'info' => __('Show or Hide wordpress admin bar from front-end.', THEME_NAME),
												'validation'=>'',
												'attrs'=>array('class' => 'input-block-level'),
											);
...
$options['general_settings']['SUB']['APIs']['yt_api'] = array(
												'label' =>__('Youtube API Key', THEME_NAME),
												'type' =>'input',
												'info' => __( 'Insert the Youtube API key to fetch data.' , THEME_NAME),
												'validation'=>'required',
												'std' => 10,
												'attrs'=>array('class' => 'input-small'),
...
$options['general_settings']['SUB']['APIs']['yt_videos_limit'] = array(
												'label' =>__('Youtube Videos limit', THEME_NAME),
												'type' =>'input',
												'info' => __( 'Limit the maximum number of videos to fetch 0 to 50.' , THEME_NAME),
												'validation'=>'required|is_natural',
												'std' => 10,
												'attrs'=>array('class' => 'input-small')
											);

$options['general_settings']['SUB']['APIs']['yt_playlists_limit'] = array(
												'label' =>__('Youtube Playlists limit', THEME_NAME),
												'type' =>'input',
												'info' => __( 'Limit the maximum number of playlists to fetch from this channel.' , THEME_NAME),
												'validation'=>'required|is_natural',
												'std' => 10,
												'attrs'=>array('class' => 'input-small'),
											);
