...
add_action( 'tgmpa_register', 'exc_uploader_register_required_plugins' );
 ...
 */
function exc_uploader_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'Extracoding Framework',
			'slug'     				=> 'exc-framework',
			'source'   				=> get_template_directory_uri() . '/includes/thirdparty/tgm-plugin-activation/plugins/exc-framework.zip',
			'required' 				=> true,
			'version' 				=> '2.3.0',
			'force_activation' 		=> TRUE,
			'force_deactivation' 	=> false,
			//'external_url' 			=> 'http://www.extracoding.com/framework/'
			//'file_path'				=>  BASEPATH . 'wp-content/plugins/exc-framework/core/base_class.php'
		),
