...
?><?php
define('TS_THEMENAME', 'videofly');

/**
 * Alert require plugins
 */
require( get_template_directory() . '/required-plugins/class-tgm.php' );
...
/**
 * Importer video extern
 */
require( get_template_directory() . '/includes/importer-video.php' );

/**
 * Code frontend submision
 */
require( get_template_directory() . '/includes/frontend-submision.php' );
...
/**
 * Include the Tabber Functions File
 */
require( get_template_directory() . '/includes/widgets/tabber.php' );
 ...
 * Include the Most liked Functions File
 */
require( get_template_directory() . '/includes/widgets/popular.php' );
