...
?>
	...
	<div class="container">
		...
		<div class="row">
			<?php if( isset($sidebar_options) && $sidebar_options['position'] === 'left' ) echo vdf_var_sanitize($sidebar_content); ?>
			...
			<?php if( isset($sidebar_options) && $sidebar_options['position'] === 'right' ) echo vdf_var_sanitize($sidebar_content); ?>
		</div>
	</div>
	<?php
