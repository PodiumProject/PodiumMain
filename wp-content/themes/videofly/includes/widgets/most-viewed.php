...
class widget_most_viewed extends WP_Widget {
    ...
    function widget_most_viewed() {
        $widget_ops = array( 'classname' => 'widget_most_viewed' , 'description' => esc_html__( " Get posts that have the most views." , 'videofly' ) );
        parent::__construct( 'widget_touchsize_most_viewed' , esc_html__( "Most viewed posts" , 'videofly' ) , $widget_ops );
    }
