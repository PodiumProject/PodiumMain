<?php
    class widget_comments extends WP_Widget {
        ...
        function widget_comments() {
            $widget_ops = array( 'classname' => 'widget_comments' , 'description' => esc_html__( 'Comments' , 'videofly' ) );
            parent::__construct( 'widget_touchsize_comments' ,  esc_html__( 'Comments' , 'videofly' ) , $widget_ops );
        }
        ...
        ?>
            ...
            <div class="widget-container">
                                ...
                                <article class="row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                        ...
                                        <div class="widget-meta">
                                            <ul>
                                                <li class="entry-author"><?php echo vdf_var_sanitize($author_url); ?></li>
                                                    <?php
                                                        $comment_time = date_i18n(get_option( 'date_format' ), strtotime($comment->comment_date) );
                                                    ?>
                                                <li class="entry-time">
                                                    <time datetime="<?php echo date('Y-m-d',strtotime($comment -> comment_date)); ?>"><?php echo vdf_var_sanitize($comment_time); ?></time>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <?php
                        ...
                        echo '<p>' . esc_html__( 'There are no comments' , 'videofly' ) . '</p>';
                    }
                ?>
                </div>
            <?php
    ...
    ?>
            ...
            <p>
                <label for="<?php echo vdf_var_sanitize($this->get_field_id('nr_comments')); ?>"><?php esc_html_e( 'Number of comments' , 'videofly' ); ?>:
                    <input class="widefat digit" id="<?php echo vdf_var_sanitize($this->get_field_id('nr_comments')); ?>" name="<?php echo vdf_var_sanitize($this->get_field_name('nr_comments')); ?>" type="text" value="<?php echo esc_attr( $nr_comments ); ?>" />
                </label>
            </p>
    <?php
        }
