...
function videopro_acplugins($plugins) {
	$_theme_required_plugins = array(
          ...
          array(
              'name'    => 'Cactus Video',
              'slug'    => 'cactus-video',
              'source'  => get_stylesheet_directory() . '/inc/plugins/plugins/cactus-video.zip',
              'required'    => true
          ),
          array(
              'name'    => 'VideoPro - Shortcodes',
              'slug'    => 'videopro-shortcodes',
              'source'  => get_stylesheet_directory() . '/inc/plugins/plugins/videopro-shortcodes.zip',
              'required'    => true
          ),
          array(
              'name'    => 'WPBakery Visual Composer',
              'slug'    => 'js_composer',
              'source'  => get_stylesheet_directory() . '/inc/plugins/plugins/visual-composer.zip',
              'required'    => true
          ),
          array(
              'name'    => 'Advance Search Form',
              'slug'    => 'advance-search-form',
              'source'  => get_stylesheet_directory() . '/inc/plugins/plugins/extras/advance-search-form.zip',
              'required'    => false
          ),
          array(
              'name'    => 'Cactus Actor',
          ...
          array(
              'name'    => 'Cactus Ads',
              'slug'    => 'cactus-ads',
              'source'  => get_stylesheet_directory() . '/inc/plugins/plugins/extras/cactus-ads.zip',
              'required'    => false
          ),
          array(
              'name'    => 'Cactus Badges',
              'slug'    => 'cactus-badges',
              'source'  => get_stylesheet_directory() . '/inc/plugins/plugins/extras/cactus-badges.zip',
              'required'    => false
          ),
          array(
              'name'    => 'Cactus Rating',
              'slug'    => 'cactus-rating',
              'source'  => get_stylesheet_directory() . '/inc/plugins/plugins/extras/cactus-rating.zip',
              'required'    => false
          ),
          array(
              'name'    => 'Easy Tab',
              'slug'    => 'easy-tab',
              'source'  => get_stylesheet_directory() . '/inc/plugins/plugins/extras/easy-tab.zip',
              'required'    => false
          )
	  );
