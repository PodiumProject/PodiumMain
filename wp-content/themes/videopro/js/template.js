;(function($){
	...
	$(document).ready(function(){
		...
		var $s_item = $('.cactus-header-search-form form i.fa, .cactus-header-search-form form .padding-small');
		$s_fn
		.on('focus', function(){
            ...
            if(is_rtl){
                if(window.innerWidth>1023){
                    ...
                    $(this).css({'width':width+'px', 'margin-left':(- width + $(this).width() + 34)+'px'});
                    $s_item.css({'margin-left':(- width + current_width + 34)+'px'});
                }else{
                    $(this).removeAttr('style');
                    $s_item.removeAttr('style');
                };
            } else {
                if(window.innerWidth>1023){
                    var offsetLeft = $(this).offset().left;
                    var offsetRight = $('.cactus-nav-main .cactus-nav-right').offset().left - 40;
                    $(this).css({'width':(offsetRight-offsetLeft)+'px'});
                    $s_item.css({'margin-right':-(offsetRight-(offsetLeft+$(this).outerWidth()))+'px'});
                }else{
                    $(this).removeAttr('style');
                    $s_item.removeAttr('style');
                };
