...
if (!class_exists('ink_widget_map')) {
    ...
    class ink_widget_map extends WP_Widget {
        ...
        function form($instance) {
            ...
            ?>
            <p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'videocraft'); ?>: <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo attribute_escape($title); ?>" /></label></p>
            ...
            <p><label for="<?php echo $this->get_field_id('address_latitude'); ?>"><?php _e('Latitude <small>(eg: 39.95)</small>','videocraft'); ?> : <input class="widefat" id="<?php echo $this->get_field_id('address_latitude'); ?>" name="<?php echo $this->get_field_name('address_latitude'); ?>" type="text" value="<?php echo attribute_escape($address_latitude); ?>" /></label></p>
            ...
            <p><label for="<?php echo $this->get_field_id('map_height'); ?>"><?php _e('Map height (in pixels)','videocraft'); ?> : <input type="text" class="widefat" rows="6" cols="20" id="<?php echo $this->get_field_id('map_height'); ?>" name="<?php echo $this->get_field_name('map_height'); ?>" value="<?php echo attribute_escape($map_height); ?>"></label></p>
