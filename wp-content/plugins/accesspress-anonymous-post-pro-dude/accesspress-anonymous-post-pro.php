...
/**
 * Plugin Name:AccessPress Anonymous Post Pro | Shared by Themes24x7.com
 * Plugin URI:https://codecanyon.net/item/accesspress-anonymous-post-pro/9160446
 * Description:AccessPress Anonymous Post Pro
 * Version:3.1.2
 * Author:AccessKeys
 * Author URI:http://www.accesspressthemes.com
        ...
        function ap_file_delete_action() {
            if ( !empty( $_POST ) && wp_verify_nonce( $_POST['_wpnonce'], 'ap-file-uploader-nonce' ) ) {
                if ( isset( $_POST['attachment_id'] ) && $_POST['attachment_id'] != '' ) {
                    $check = wp_delete_attachment( $_POST['attachment_id'], true );
                } else {
