        ...
        switch ( $field_array['field_type'] ) {
            ...
            case 'custom':
                ...
                if ( $field_array['textbox_type'] == 'textarea' ) {
                    ...
                    $form .='<div class="ap-file-uploader" id="ap-file-uploader-' . $file_upload_counter . '" data-extensions="' . $file_types . '" data-size="' . $upload_size . '" data-multiple="' . $multiple_upload . '" data-upload-limit="' . $upload_limit . '" data-uploader-label="' . $uploader_label . '" data-upload-limit-message="' . $upload_limit_message . '" data-media-attachment="' . $media_attachment . '">
                     </div>
                          ';
