    ...
    <div class="ap-tab-wrapper">
        <div class="ap-option-wrapper">
            ...
            <div class="ap-option-field">
                ...
                <div class="ap-option-note ap-option-width"><?php _e( 'W.P.L.O.C.K.E.R..C.O.M - Add upto 3 extra email address for the admin notification.Only Site Admin will recieve notification if you don\'t add any.', 'anonymous-post-pro' ); ?></div>
            </div>
        </div>
        <div class="ap-option-wrapper">
...
Thank you'
        ...
        <div class="ap-option-wrapper">
            <label><?php _e( 'Post Rejection Notification', 'anonymous-post' ); ?></label>
            <div class="ap-option-field">
                <div class="ap-option-checkbox-field">
