                    ...
                    if (Object.getOwnPropertyNames(res).length != 0)
                    {
                        ...
                        for (i = 0; i < taxonomies.length; i++)
                        {
                            ...
                            taxonomy_html += '<option value="dropdown" selected="selected">Dropdown</option>\n\
                                    ...
                                    '<p><strong>Textfield:</strong>It will show textfield to add new items using comma for multiple items</p>' +
                                    '<p><strong>Dropdown & Checkbox:</strong>It will show already available items as dropdown or checkbox</p>' +
                                    '</div>' +
                                    '</div>' +
                                    '</li>';
                            taxonomy_html += '<li class="ap-taxonomy-autocomplete" style="display:none">' +
                                    ...
                                    '<div class="ap-option-note ap-option-width">Check if you want to enable auto complete for this tags/terms</div>' +
                                    '</div>' +
                                    '</li>';
                            taxonomy_html += '<li class="ap-taxonomy-multiple">' +
                                    ...
                                    '<div class="ap-option-note ap-option-width">Check if you want to allow users to select multiple items pressing control or command key</div>' +
                                    '</div>' +
                                    '</li>';
                            taxonomy_html += '<li class="ap-taxonomy-multiple">' +
                                    '<label>Dropdown First Option Label</label>' +
                                    '<div class="ap-pro-checkbox">' +
                                    '<input type="text" name="form_fields[' + taxonomies[i] + '][first_option_label]"/>' +
                                    '<div class="ap-option-note ap-option-width">Please enter the first option label of the dropdown.</div>' +
                                    '</div>' +
                                    '</li>';
                            taxonomy_html += '<li>' +
                                    '<label>Exclude Categories/Tags/Terms</label>' +
                                    '<div class="ap-pro-textbox">' +
                                    '<input type="text" name="form_fields[' + taxonomies[i] + '][exclude_terms]" />' +
                                    '<div class="ap-option-note ap-option-width">' +
                                    'Please add the <b>slugs</b> of the categories/tags/terms separated by comma that you want<br/> to exclude while showing in the front form.For e.g:category-3,category-2' +
                                    '</div>' +
                                    '</div>' +
                                    '</li>';
