...
if(!function_exists('smartcontentbox_query')){
	function smartcontentbox_query($number, $conditions, $sort_by, $categories, $tags, $ids, $paged, $offset = false, $postformat = false, $timerange = 'all') {
...
if(!function_exists('videopro_video_inline')){
	function videopro_video_inline($id_sc='') {
		if(function_exists('tm_video')){
			...
			$jsonIframeVideo = array('<div class="player-inline">'.$strIframeVideo.'</div>');
