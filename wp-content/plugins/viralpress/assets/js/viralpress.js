		...
		'<div class="more_items more_items_numbered">'+
			'<fieldset>'+
				...
				'<div class="vp-pull-right vp-pointer">'+
					...
					'<i class="glyphicon glyphicon-trash remove_entry" title="'+ lang.remove_entry +'"></i>'+
				'</div>'+
				'<label for="entry_text[[f_number]]">'+ lang.title +'</label>'+
				'<input type="text" name="entry_text[[f_number]]" class="entry_text vp-form-control" placeholder="'+lang.type_title+ ' ' + lang.optional +'"/>'+
				'<label for="entry_desc[[f_number]]">'+ lang.desc +'</label>'+
				...
				'name="entry_desc[[f_number]]" placeholder="'+lang.type_desc+ ' ' + lang.required +'"></textarea>'+
				'<label for="entry_source[[f_number]]">'+ lang.source +'</label>'+
				'<input type="text" name="entry_source[[f_number]]" class="entry_source vp-form-control" placeholder="'+lang.type_source+ ' ' + lang.optional +'"/>'+
				...
				'<span class="show_numering">'+ lang.show_numering +'</span>'+
			'</fieldset>'+
		'</div>';
		
	var list_entry_template = 
		'<div class="more_items more_items_numbered">'+
			'<fieldset>'+
				'<!--title-->'+
				'<div class="vp-pull-right vp-pointer">'+
				...
				'<div class="row">'+
						...
						'<div class="vp-uploader vp-uploader-list vp-uploader-lesspad text-center" data-target="entry_images[[f_number]]">'+
                            '<button class="thumbnail_uploader list_img btn btn-sm btn-danger">'+
                                '<i class="glyphicon glyphicon-picture"></i>&nbsp;&nbsp;<span class="default_text">'+
                                 lang.upload_photo +
								 '</span><span class="dload_text" style="display:none">'+lang.downloading+'</span>'+
                            '</button>'+
							'<span class="list_exclusive">'+
								'<h4 class="big_or">'+lang.big_or+'</h4>'+
								'<span class="thumbnail_uploader list_img thumbnail_uploader_url vp-pointer" style="font-size:15px">'+
									'<i class="glyphicon glyphicon-link"></i>&nbsp;<small>'+lang.upload_from_link+'</small>'+
								'</span>'+
							'</span>'+
                        '</div>'+
					...
					'<div class="col-lg-7">'+
						...
						'</div>'+
						'<textarea id="tareaid" class="entry_desc tinymce vp-form-control" '+
						'name="entry_desc[[f_number]]" placeholder="'+lang.type_desc+ ' ' + lang.optional +'"></textarea>'+
						'<label for="entry_source[[f_number]]">'+ lang.source +'</label>'+
						'<input type="text" name="entry_source[[f_number]]" class="entry_source vp-form-control" placeholder="'+lang.type_source+ ' ' + lang.optional +'"/>'+
		...
		'<div class="more_items more_items_numbered quiz_parent" data-quiz-rel="[f_number]">'+
			...
			'<fieldset>'+
				...
				'<div class="row">'+
					'<div class="col-lg-12">'+
						'<label for="entry_text[[f_number]]">'+ lang.question +'</label>'+
						'<input type="text" name="entry_text[[f_number]]" class="entry_text vp-form-control" placeholder="'+lang.type_qu+'"/><br/><br/>'+
						'<div class="row">'+
							'<div class="col-lg-5">'+	
				...
				'<div class="row">'+
					'<div class="col-lg-12">'+
						'<br/><button class="btn btn-sm btn-info add_more_ans"><i class="glyphicon glyphicon-plus"></i>&nbsp;'+lang.add_answer+'</button>&nbsp;&nbsp;'+
						'<button class="btn btn-sm btn-danger show_explain_ans"><i class="glyphicon glyphicon-adjust"></i>&nbsp;'+lang.explain_answer+'</button>'+
						'<br/><br/>'+
					'</div>'+
				'</div>'+
				'<div class="vp-clearfix"></div>'+
				'<div class="row quiz_ans_exp" style="display:none">'+
					'<div class="col-lg-12">'+
						'<label for="explain_text[[f_number]]">'+ lang.title_of_exp +'</label>'+
						'<input type="text" name="explain_text[[f_number]]" class="explain_text vp-form-control" placeholder="'+lang.title_of_exp+'"/><br/><br/>'+
						'<div class="row">'+
							'<div class="col-lg-5">'+	
							...
							'</div>'+
							'<div class="col-lg-7">'+
								'<label for="explain_desc[[f_number]]">'+ lang.desc_of_exp +'</label>'+
								'<textarea id="explain_tareaid" class="explain_desc tinymce vp-form-control" '+
								'name="explain_desc[[f_number]]" placeholder="'+lang.desc_of_exp+ ' ' + lang.optional +'"></textarea>'+
							'</div>'+
						'</div>'+
					'</div>'+	
				'</div>'+
		...
		'<div class="col-lg-4 more_items_x">'+
			'<div class="more_ans">'+
				...
				'</div>'+
				'<div class="vp-pull-right vp-pointer">'+
					'<i class="glyphicon glyphicon-trash remove_ans_entry" title="'+ lang.remove_entry +'"></i>'+
				'</div>'+
				'<label for="quiz_answer[[f_number]][[f_number_1]]">'+ lang.answer +'&nbsp;-&nbsp;<span class="entry-no">[number_1]</span></label>'+
				'<input type="text" name="quiz_answer[[f_number]][[f_number_1]]" class="entry_text vp-form-control" placeholder="'+lang.type_ans+ '"/>'+
				'<div class="for_personality_quiz" style="display:none">'+
					'<label for="quiz_answer_result_p1[[f_number]][[f_number_1]]">'+ lang.result +'&nbsp;-&nbsp;<span class="entry-no">[number_1]</span></label>'+
		...
		var gallery_entry_template = 
		'<div class="more_items more_items_numbered">'+
			'<fieldset>'+
				'<legend>'+lang.gallery+'</legend>'+
				'<div class="vp-pull-right vp-pointer">'+
					'<span class="entry-no">[number]</span>&nbsp;&nbsp;'+
					'<i class="glyphicon glyphicon-trash remove_entry" title="'+ lang.remove_entry +'"></i>'+
				'</div>'+
                        ...
                        '<div class="vp-uploader-nopad vp-uploader-nopad-list">'+
                            ...
                            '<button class="gallery_uploader btn btn-sm btn-info change-item-btn">'+
                                '<i class="glyphicon glyphicon-picture"></i>&nbsp;&nbsp;<span class="default_text">'+
                                 lang.add_more_photo +
								 '</span>'+
                            '</button>&nbsp;&nbsp;<button class="btn btn-sm btn-primary more_details_btn"><i class="glyphicon glyphicon-plus"></i>&nbsp;'+lang.more_details+'</button>&nbsp;<button class="btn btn-sm btn-primary hide_details_btn" style="display:none"><i class="glyphicon glyphicon-minus"></i>&nbsp;'+lang.hide_details+'</button>'+
                        '</div>'+
					'</div>'+
				'</div>'+
				'<div class="row more_details" style="display:none">'+
					'<div class="col-lg-12">'+
						...
						'<div class="gal_more_details">'+
							'<label>'+lang.gal_type+'</label>&nbsp;&nbsp;'+
							'<select name="gal_type[[f_number]]" class="gal_type">'+
								'<option value="rectangular">'+lang.rectangular+'</option>'+
								...
								'<option value="slideshow">'+lang.slideshow+'</option>'+
							'</select>&nbsp;&nbsp;'+
							'<label>'+lang.gal_cols+'</label>&nbsp;&nbsp;'+
							...
							'</select>&nbsp;&nbsp;'+
							'<label>'+lang.gal_autostart+'</label>&nbsp;&nbsp;'+
		...
		var playlist_entry_template = gallery_entry_template;
		playlist_entry_template = playlist_entry_template.replace(lang.gallery, lang.playlist);
		playlist_entry_template = playlist_entry_template.replace(lang.sel_img, lang.sel_playlist);
		playlist_entry_template = playlist_entry_template.replace(/<div class="gal_more_details">([\s\S]*?)<label for="entry_text/g, '<label for="entry_text');
		playlist_entry_template = playlist_entry_template.replace('entry_images', 'entry_media');
		playlist_entry_template = playlist_entry_template.replace(/gallery_uploader/g, 'playlist_uploader');
		playlist_entry_template = playlist_entry_template.replace('value="gallery"', 'value="playlist"');
		playlist_entry_template = playlist_entry_template.replace(lang.add_more_photo, lang.add_more_media);
		
		var num_code = jQuery(list_entry_template).find('.show_num_hold .col-lg-12').html();
		
		var quiz_entry_template = quiz_poll_entry_template.replace(/\<\!--title--\>/g, '<legend>' + lang.quiz + '</legend>' + lang.correct_answer+':&nbsp;<select id="correct_answer[[f_number]]" class="correct_answer" name="correct_answer[[f_number]]"></select>');
		
		var quiz_result_entry_template = list_entry_template;
		...
		quiz_result_entry_template = quiz_result_entry_template.replace(/\<\!--title--\>/g, '<legend>' + lang.results + '</legend>' +lang.scoring+':&nbsp;<select id="quiz_res_from_[f_number]" class="quiz_res_from_score" name="quiz_score_from[[f_number]]"></select>&nbsp;'+ lang.to +'&nbsp;<select id="quiz_res_to_[f_number]" class="quiz_res_to_score" name="quiz_score_to[[f_number]]"></select><input type="hidden" name="quiz_score_sheet[[f_number]]" value="1"/>');
	
		var poll_entry_template = quiz_poll_entry_template.replace(/value="quiz"/, 'value="poll"');
		poll_entry_template = poll_entry_template.replace(/\<\!--title--\>/g, '<legend>' + lang.poll + '</legend>' );
		poll_entry_template = poll_entry_template.replace(/show_explain_ans\"/g, 'show_explain_ans" style="display:none"' );

		
		var video_entry_template = list_entry_template;
		video_entry_template = video_entry_template.replace(/<span class="list_exclusive">([\s\S]*?)<\/span>/g, '');
		video_entry_template = video_entry_template.replace(/vp-uploader-lesspad/g, 'vp-uploader-lesspad-3');
		video_entry_template = video_entry_template.replace(lang.change_photo, lang.change_video);
		video_entry_template = video_entry_template.replace(lang.upload_photo, lang.add_video);
		video_entry_template = video_entry_template.replace(/<!--title-->/g, '<legend>'+lang.video+'</legend>');
		video_entry_template = video_entry_template.replace(/value="list"/g, 'value="video"');
		video_entry_template = video_entry_template.replace('glyphicon-picture', 'glyphicon-film');
		video_entry_template = video_entry_template.replace('entry_images', 'entry_videos');
		video_entry_template = video_entry_template.replace(/list_img/g, 'list_video');
		video_entry_template = video_entry_template.replace(/-list/g, '-video');
		video_entry_template = video_entry_template.replace(/list-/g, 'video-');
		
		var audio_entry_template = video_entry_template;
		audio_entry_template = audio_entry_template.replace(lang.change_video, lang.change_audio);
		audio_entry_template = audio_entry_template.replace(lang.add_video, lang.add_audio);
		audio_entry_template = audio_entry_template.replace(lang.video, lang.audio);
		audio_entry_template = audio_entry_template.replace(/value="video"/g, 'value="audio"');
		audio_entry_template = audio_entry_template.replace('glyphicon-film', 'glyphicon-sound-stereo');
		audio_entry_template = audio_entry_template.replace('entry_videos', 'entry_audio');
		audio_entry_template = audio_entry_template.replace(/list_video/g, 'list_audio');
		audio_entry_template = audio_entry_template.replace(/video/g, 'audio');
		audio_entry_template = audio_entry_template.replace(/-video/g, '-audio');
		audio_entry_template = audio_entry_template.replace(/video-/g, 'audio-');
		
		var wide_template = list_entry_template;
		wide_template = wide_template.replace(/<span class="list_exclusive">([\s\S]*?)<\/span>/g, '');
		wide_template = wide_template.replace(lang.change_photo, lang.change_video);
		wide_template = wide_template.replace(lang.upload_photo, lang.add_video);
		wide_template = wide_template.replace(/<!--title-->/g, '<legend>'+lang.video+'</legend>');
		wide_template = wide_template.replace(/value="list"/g, 'value="video"');
		wide_template = wide_template.replace('glyphicon-picture', 'glyphicon-film');
		wide_template = wide_template.replace('entry_images', 'entry_videos');
		wide_template = wide_template.replace(/thumbnail_uploader/g, 'add_video');
		wide_template = wide_template.replace(/<div class="col-lg-5">/g, '<div class="col-lg-12">');
		wide_template = wide_template.replace(/<div class="col-lg-7">/g, '</div><div class="row more_details" style="display:none"><div class="col-lg-12"><br/>');
		wide_template = wide_template.replace(/class="vp-uploader text-center"/g, 'class="vp-uploader vp-uploader-lesspad text-center"');
		wide_template = wide_template.replace(/<\!--more_buttons-->/g, '&nbsp;<button class="btn btn-sm btn-primary more_details_btn"><i class="glyphicon glyphicon-plus"></i>&nbsp;'+lang.more_details+'</button>&nbsp;<button class="btn btn-sm btn-primary hide_details_btn" style="display:none"><i class="glyphicon glyphicon-minus"></i>&nbsp;'+lang.hide_details+'</button>');
	
		
		var pin_entry_template = wide_template;
		pin_entry_template = pin_entry_template.replace(lang.change_video, lang.change_pin);
		pin_entry_template = pin_entry_template.replace(lang.add_video, lang.add_pin);
		pin_entry_template = pin_entry_template.replace(lang.video, lang.pin);
		pin_entry_template = pin_entry_template.replace(/value="video"/g, 'value="pin"');
		pin_entry_template = pin_entry_template.replace('glyphicon-film', 'glyphicon-calendar');
		pin_entry_template = pin_entry_template.replace('entry_videos', 'entry_pins');
		pin_entry_template = pin_entry_template.replace(/add_video/g, 'add_pin');
		
		list_entry_template = list_entry_template.replace(/\<\!--title--\>/g, '<legend>' + lang.image + '</legend>' );
		
		/***
		 * open list templates
		 */
		var openlist_list_template = 
		'<div class="more_items">'+
            ...
            '<div class="open_list_desc_more more_details" style="display:none">'+
                ...
                '<input type="text" class="vp-form-control" name="open_list_title" id="open_list_title" placeholder="'+lang.type_title+'">'+
                '<label>'+lang.desc+'</label>'+
                '<textarea name="open_list_desc" id="open_list_desc" class="tinymce"></textarea>'+  
                '<label for="open_list_source">'+ lang.source +'</label>'+
				'<input type="text" name="open_list_source" class="open_list_source vp-form-control" placeholder="'+lang.type_source+ ' ' + lang.optional +'"/>'+
				'<br/><br/><input type="checkbox" name="open_list_num" value="1" checked/>&nbsp;&nbsp;'+lang.show_numering+
				'<br/><br/>'+
                '<button class="btn btn-info submit_open_list">'+lang.submit+'</button>'+          
            '</div>'+
        '</div>'+
		'<input type="hidden" name="open_list_entry_type" value="list" />'; 
		
		var openlist_news_template = 
		'<div class="more_items">'+
		...
		'<div class="more_items">'+				
            ...
            '<div class="open_list_desc_more more_details" style="display:none">'+
				...
				'<div class="gal_more_details">'+
					...
					'<div class="vp-clearfix"></div>'+
                '</div>'+
				'<label for="open_list_title">'+lang.title+'</label>'+
                '<input type="text" class="vp-form-control" name="open_list_title" id="open_list_title" placeholder="'+lang.type_title+'">'+
                '<label>'+lang.desc+'</label>'+
                '<textarea name="open_list_desc" id="open_list_desc" class="tinymce"></textarea>'+  
                '<label for="open_list_source">'+ lang.source +'</label>'+
		...
		var openlist_playlist_template = openlist_gallery_template;
		openlist_playlist_template = openlist_playlist_template.replace(lang.gallery, lang.playlist);
		openlist_playlist_template = openlist_playlist_template.replace(lang.sel_img, lang.sel_playlist);
		openlist_playlist_template = openlist_playlist_template.replace(/<div class="gal_more_details">([\s\S]*?)<label for="open_list_title/g, '<label for="open_list_title');
		openlist_playlist_template = openlist_playlist_template.replace('entry_images', 'entry_media');
		openlist_playlist_template = openlist_playlist_template.replace('gallery_uploader', 'playlist_uploader');
		openlist_playlist_template = openlist_playlist_template.replace('value="gallery"', 'value="playlist"');
		openlist_playlist_template = openlist_playlist_template.replace(lang.add_more_photo, lang.add_more_media);
		
		var openlist_video_template = openlist_list_template;
		openlist_video_template = openlist_video_template.replace(/<span class="list_exclusive">([\s\S]*?)<\/span>/g, '');
		openlist_video_template = openlist_video_template.replace(lang.change_photo, lang.change_video);
		openlist_video_template = openlist_video_template.replace(lang.upload_photo, lang.add_video);
		openlist_video_template = openlist_video_template.replace(/<!--title-->/g, '<legend>'+lang.video+'</legend>');
		openlist_video_template = openlist_video_template.replace(/value="list"/g, 'value="video"');
		openlist_video_template = openlist_video_template.replace('glyphicon-picture', 'glyphicon-film');
		openlist_video_template = openlist_video_template.replace('entry_images', 'entry_videos');
		openlist_video_template = openlist_video_template.replace(/list_img/g, 'list_video');
		openlist_video_template = openlist_video_template.replace(/list-/g, 'video-');
		openlist_video_template = openlist_video_template.replace(/-list/g, '-video');
		openlist_video_template = openlist_video_template.replace(/class="vp-uploader text-center"/g, 'class="vp-uploader vp-uploader-lesspad text-center"');
		
		var openlist_audio_template = openlist_video_template;
		openlist_audio_template = openlist_audio_template.replace(lang.change_video, lang.change_audio);
		openlist_audio_template = openlist_audio_template.replace(lang.add_video, lang.add_audio);
		openlist_audio_template = openlist_audio_template.replace(lang.video, lang.audio);
		openlist_audio_template = openlist_audio_template.replace(/value="video"/g, 'value="audio"');
		openlist_audio_template = openlist_audio_template.replace('glyphicon-film', 'glyphicon-sound-stereo');
		openlist_audio_template = openlist_audio_template.replace('entry_videos', 'entry_audio');
		openlist_audio_template = openlist_audio_template.replace(/add_video/g, 'add_audio');
		openlist_audio_template = openlist_audio_template.replace(/list_video/g, 'list_audio');
		openlist_audio_template = openlist_audio_template.replace(/video-/g, 'audio-');
		openlist_audio_template = openlist_audio_template.replace(/-video/g, '-audio');
		
		
		var openlist_embed_template = openlist_list_template;
		openlist_embed_template = openlist_embed_template.replace(/<span class="list_exclusive">([\s\S]*?)<\/span>/g, '');
		openlist_embed_template = openlist_embed_template.replace(lang.change_photo, lang.change_pin);
		openlist_embed_template = openlist_embed_template.replace(lang.upload_photo, lang.add_pin);
		openlist_embed_template = openlist_embed_template.replace(/<!--title-->/g, '<legend>'+lang.pin+'</legend>');
		openlist_embed_template = openlist_embed_template.replace(/value="list"/g, 'value="pin"');
		openlist_embed_template = openlist_embed_template.replace('glyphicon-picture', 'glyphicon-calendar');
		openlist_embed_template = openlist_embed_template.replace('entry_images', 'entry_pins');
		openlist_embed_template = openlist_embed_template.replace(/class="vp-uploader text-center"/g, 'class="vp-uploader vp-uploader-lesspad text-center"');
		openlist_embed_template = openlist_embed_template.replace(/thumbnail_uploader/g, 'add_pin');
}
...
jQuery(document).ready(function($) {
	...
	*/
	...
	$(document).on( 'click', '.vp_open_list_del' , function(e){
		...
		$('<img src="'+spinner_url+'" class="vp_open_list_del_spinner"/>').insertAfter(self);
		$.post( ajaxurl, {
			...
			if( data.error != '' ) {
				...
				if( self.parents('.vp-op-bp-wrap:first').length > 0 ) {
					...
					$('.vp-entry[data-rel="'+pid+'"]').html( '<div class="alert alert-info">' + lang.entry_deleted + '</div>' );
				}
			}	
		});
	});
	...
	$(document).on( 'click', '.submit_open_list' , function(e){
		...
		$('.open_list_form_feedback').html(lang.submitting_open_list).show();
		...
		, function( response ){
			...
			if( data.error != '' ) {
				...
				self.show();
				$('.open_list_form_feedback').html(lang.submitted_open_list).show();
	...
	$(document).on( 'click', '.vp-dash-media' , function(e){
		...
		wp.media.view.l10n.insertIntoPost = lang.save;
		wp.media.view.l10n.insertFromUrlTitle = lang.upload_from_url;
		wp.media.view.l10n.insertMediaTitle = lang.manage_media;
	...
	$(document).on( 'click', '.gallery_uploader' , function(e){
		...
		wp.media.view.l10n.insertIntoPost = lang.insert;
		wp.media.view.l10n.insertFromUrlTitle = lang.upload_from_url;
		wp.media.view.l10n.insertMediaTitle = lang.upload_media;
	...
	$(document).on( 'click', '.playlist_uploader' , function(e){
			...
			if(selected.length > 0){
				...
				for( k = 0; k < selected.length; k++ ) {
					if( k == 0 ){
						...
						return alert( lang.one_type_playlist );
					}
		...
		$('.attachment-filters').val('video').trigger('change');
	...
	$(document).on( 'click', '.thumbnail_uploader' , function(e){
		...
		frame.on('insert', function() {
			...
			if( first.type != type ) return alert( type +' ' + lang.vp_req );
		...
		if( type == 'video' ) $('.attachment-filters').val('video').trigger('change');
		else if( type == 'audio' ) $('.attachment-filters').val('audio').trigger('change');
	...
	$(document).on( 'click', '.edit-profile-images' , function(e){
		...
		frame.on('insert', function() {
			...
			if( first.type != 'image' ) return alert( lang.img_req );
			...
			if( avatar == 1 || avatar == 2 ) {
				$.post( ajaxurl, {
					'media_id': id,
					'action': avatar ? 'vp_set_avatar' : 'vp_set_cover',
					'_nonce': ajax_nonce
				}, function( response ){
					var data = $.parseJSON( response );
					if( data.error != '' ) {
	...
	$(document).on( 'mousedown', 'li.attachment' , function(){
		...
		setTimeout(function(){
			...
			var u = '<a href="'+meme_gen_url+'?media_id='+id+'" target="_blank" class="vp-meme-gen-link">'+lang.gen_meme+'</a><br/>';
	...
	$(document).on( 'click', '.add_video_submit' , function(){
		...
		var allowed_embeds_regex = new RegExp( allowed_embeds, 'ig' );
		var err = $('.video_add_error_msg');
		var vid = 0;
		err.html('');
		var url = $('#video_url').val();
		if(url == '')return err.html( '<div class="alert alert-danger">' +lang.insert_url+ '</div>' ).show();
		...
		if( 
			!domain.match(/youtube\.com|youtu\.be|facebook\.com|fb\.com|dailymotion\.com|vimeo\.com|vine\.co|ted\.com|bbc\.co|liveleak\.com/g) && !domain.match( allowed_embeds_regex )
		  )
		return err.html( '<div class="alert alert-danger">' +lang.choose_valid_video_domain+ '</div>' ).show();
		...
		v_err = lang.invalid_url;
		if( site == 'liveleak' && !vid )v_err = lang.lk_embed_url;
	...
	$(document).on( 'click', '.add_audio_submit' , function(){
		...
		if( !domain.match(/soundcloud\.com/g)  && !domain.match( allowed_embeds_regex ) ){
			return err.html( '<div class="alert alert-danger">' +lang.choose_valid_audio_domain+ '</div>' ).show();	
		}
		...
		if( !aid )return err.html( '<div class="alert alert-danger">' +lang.invalid_url+ '</div>' ).show();
	...
	$(document).on( 'click', '.add_pin_submit' , function(){
		...
		if( 
			!domain.match(/instagram\.com|instagra\.me|facebook\.com|fb\.com|twitter\.com|pinterest\.com|vine\.co|plus\.google\.com|youtube\.com|youtu\.be|dailymotion\.com|vimeo\.com|ted\.com|bbc\.co|liveleak\.com|soundcloud\.com/g)
			  && !domain.match( allowed_embeds_regex ) 
		  )
		return err.html( '<div class="alert alert-danger">' +lang.choose_valid_pin_domain+ '</div>' ).show();
		...
		if( !eid )return err.html( '<div class="alert alert-danger">' +lang.invalid_url+ '</div>' ).show();
	...
	$(document).on( 'click', '.quiz_row' , function(){
		if( typeof poll_submit != 'undefined' ) {
			if( ( user_logged_in == '' || user_logged_in == 0 )  && allow_anon_votes == 0  ) {
				modal_open( jQuery('.login_modal_link') );
				resize_modal(350, 600);
				return false;	
			}	
	...
	$(document).on( 'click', '.editor_add_preface' , function( e ){
		...
		jQuery('.editor_preface').slideToggle( function(){
			if( $('.editor_preface' ).is( ':hidden' ) == true ) {
				$( '.editor_add_preface' ).html( '<i class="glyphicon glyphicon-plus"></i>&nbsp;' + lang.add_preface );	
			}
			else $( '.editor_add_preface' ).html( '<i class="glyphicon glyphicon-minus"></i>&nbsp;' + lang.hide_preface );	
		});
	});
	...
	$(document).on( 'click', '.fb-share-quiz-res' , function(){
		...
		FB.ui({
		  ...
		  link: u
			...
			else alert( lang.must_share_quiz );	
		});
		return false;
	});
	...
	jQuery(document).on( 'click', '.vp-fb-login-button' , function(){
		FB.login( function(response) {
			if( response.status == 'connected' ) {
				jQuery('.login-error').html('<div class="alert alert-info">' + lang.login_success_wait + '</div>');
				jQuery.post(
					ajaxurl, {
						'action': 'vp_fb_auth',
				...
				$('.login-error').html('<div class="alert alert-danger">' + lang.login_failed + '</div>');
			} 
		}, {scope: 'email'});
		return false;
	});
	...
	jQuery(document).on( 'click', '.vp_mass_post_action_btn' , function( e ){
		e.preventDefault();
		if( !confirm( lang.confirm_action ) ) return;
		var action = $('select[name="vp_mass_post_action"]').val();
		if( action == '' )return;//alert( lang.sel_mass_action );
		var post_ids = [];
		$( '.vp_post_sel' ).each( function(){
			if( $(this).is( ':checked' ) == true )post_ids.push( $(this).val() );
		});
		
		if( post_ids.length <= 0 )return alert( lang.sel_at_one_post );
	...
	jQuery(document).on( 'click', '.vp_single_post_publish' , function(){
		var post_id = $(this).parents('tr:first').attr( 'data-rel' );
	...
	jQuery(document).on( 'click', '.vp_single_post_delete' , function(){
		if( !confirm( lang.confirm_action ) )return false;
	...
	jQuery(document).on( 'click', '.vp_submit_post' , function(){
		...
		, function( response ){
			...
			var data = $.parseJSON( response );
			if( data.success == 1 ) {
				document.title = lang.edit_post_title;
	...
	jQuery(document).on( 'click', '.poll_submit_btn' , function(){
		...
		$('.poll-feedback').html( lang.login_success_wait ).show();		
		$('.quiz_ans_list').each( function() {
			c = jQuery(this).find('input[type="checkbox"]:checked');
			if( c.length == 0 ){
				return $('.poll-feedback').html( '<div class="alert alert-danger">' + lang.all_required + '</div>' );	
			}
		...
		$.post( ajaxurl, {
			...
			if( data.error != '' ) {
				...
				$('.quiz_ans_list_obs').show();
				$('.poll_submit').hide();
				$('.poll-feedback').html( '<div class="alert alert-success">' + lang.vote_done + '</div>' );
	...
	jQuery(document).on( 'click', '.emoji_row_nosel > div' , function(){
		...
		//else if( $('.emoji_row_sel').length > 0 ) {
			//vp_action_pending = 0; 
			//return alert( lang.withdraw_last_vote );			
		//}
		else {
		...
		$.post( ajaxurl, {
			...
			setTimeout( set_action_done, 1000 ); 
			var data = $.parseJSON( response );
			if( data.error != '' ) {
				alert( data.error );				
				if( self.hasClass( 'emoji_row_sel' ) ) {
	...
	jQuery(document).on( 'click', '.react_with_gif' , function(){
		...
		if( url == '' ) {
			return alert( lang.url_required_react );	
		}
		
		self.hide();
		$('.vp_react_gif_feed').html( lang.login_success_wait ).show();
	...
	if( typeof create_post != 'undefined' && typeof prevent_new_item == 'undefined' ){
		...
		else if( create_post == 'list')add_new_entry( 'list' );
		else if( create_post == 'video')add_new_entry( 'video' );
		else if( create_post == 'audio')add_new_entry( 'audio' );
		else if( create_post == 'pin')add_new_entry( 'pin' );
	...
	jQuery.post( ajaxurl, {
		...
		if( action == 'vp_mass_delete_post' ){
			...
			for( i = 0; i < d.length; i++ ) {
				jQuery('.p_'+d[i]).html('<td colspan="10"><div class="alert alert-info">' +lang.deleted+ '</div></td>');	
			}
		}
		...
		if( data.post_count != data.edit_count ) {
			alert( (data.post_count - data.edit_count) + ' ' + lang.could_not_edit)	
		}
	});	
}
...
function OnGoogleAuth( googleUser ) {
	...
	if(googleUser['status']['signed_in']) { 
		...
		jQuery('.login-error').html('<div class="alert alert-danger">' + lang.login_failed + '</div>');
	}   
}
...
function add_new_entry( type )
{
	...
	if( type == 'news' ) {	
		var data = text_entry_template;
	}
	else if( type == 'list' ) {
		var data = list_entry_template;	
	}
	else if( type == 'video' ) {
		var data = video_entry_template;	
	}
	else if( type == 'audio' ) {
		var data = audio_entry_template;	
	}
	else if( type == 'pin' ) {
		var data = pin_entry_template;	
	}
	else if( type == 'gallery' ) {
		var data = gallery_entry_template;	
	}
	else if( type == 'playlist' ) {
		var data = playlist_entry_template;	
	}
	else if( type == 'quiz' ) {
	...
	if( type == 'results' ){
		...
		jQuery('.personality_res_ans').append('<option value="'+count_numbered+'">'+lang.result+' - '+count_numbered+'</option>');
	}
...
function get_pin_code( site, eid, small, w, h, elem_id )
{
    ...
    if( site == 'facebook' ){
		...
		if( typeof twttr != 'undefined' )
			...
			return '<blockquote class="twitter-tweet" lang="en"><a href="https://twitter.com/user/status/'+eid+'"></a></blockquote>';
    }
	...
	else if( eid.match( allowed_embeds_regex ) ) {
...
function get_video_embed_code( site, vid, small, w, h )
{
	...
	else if( vid.match( allowed_embeds_regex ) ) {
...
function add_thumb_image(parent, media_id, media_url, data)
{
	...
	if( type == 'video' ) {
		...
		if( data != null ) html += data;
		vp_uploader_nopad.find('.vp-uploader-image-'+type).eq(0).html('<audio controls src="'+media_url+'"></audio><br/>'+html);
	}
...
function reverse_embed(parent, code) {
	...
	else if( vid.match( allowed_embeds_regex ) ) url = vid;
...
function check_quiz_answers( elem )
{
	...
	if( ok == 1 ) {
		...
		jQuery('.score_score').html( ' <span class="entry-no-lg">' + lang.you_score + ' : ' + t_score + ' ' + lang.out_of + ' ' + total_marks + '</span>' );
		if( score_sheet_fixed_ans == 1 )jQuery('.score_title').html( score_elem.title );
		else jQuery('.score_title').html( lang.you_got + ' : ' + score_elem.title );
		
		if( score_elem.image != '' )jQuery('.score_image').html( '<img src="'+ score_elem.image+'" style="max-height:200px !important"/>' );
		jQuery('.score_desc').html( score_elem.desc );
		
		if( share_quiz_force == 1 )jQuery('.quiz_hhh').hide();
			...
			h += '<tr>'+
					...
					'<td>'+ data[i].results[j].title +'  <div class="progress">'+
  					...
  					'aria-valuemin="0" aria-valuemax="100" style="width:'+ p +'%">'+
    					'<span class="sr-only">'+ p + '% '+ lang.votes +'</span>'+
  					'</div>'+
				 '</div></td><td style="width:20%"><span class="entry-no">&nbsp;&nbsp;&nbsp;'+ data[i].results[j].votes +'</span> '+lang.votes+'</td></tr>';
		}
		h += '</table>';
...
{
	if( elem.length <= 0 ) {
		if( elem.hasClass( 'login_modal_link' ) )alert( lang.must_login );
		return false;	
	}
...
function vp_open_list_tab_activate( elem )
{
	...
	if( elem.hasClass( 'vp-op-list' )){
		c = '.vp-op-list';
		template = openlist_list_template;
	}
	else if( elem.hasClass( 'vp-op-news' )){
		c = '.vp-op-news';
		template = openlist_news_template;
	}
	else if( elem.hasClass( 'vp-op-embed' )){
		c = '.vp-op-embed';
		template = openlist_embed_template;
	}
	else if( elem.hasClass( 'vp-op-video' )){
		c = '.vp-op-video';
		template = openlist_video_template;
	}
	else if( elem.hasClass( 'vp-op-audio' )){
		c = '.vp-op-audio';
		template = openlist_audio_template;
	}
	else if( elem.hasClass( 'vp-op-gallery' )){
		c = '.vp-op-gallery';
		template = openlist_gallery_template;
	}
	else if( elem.hasClass( 'vp-op-playlist' )){
		c = '.vp-op-playlist';
		template = openlist_playlist_template;
	}
...
function get_playlist_editor_html( media_id, url, type, name, elem, size ) 
{
	var tt = elem.attr('data-target');
	return '<div class="vp_editor_gal_img vp-pull-left">'+
				'<div class="vp_editor_gal_img_overlay"><div><div class="vp_editor_gal_img_main" style="width:'+size+'px; height:'+size+'px; background-size:cover; background-image: url(\''+img_dir_url+'/'+type+'.png\')"></div>'+
