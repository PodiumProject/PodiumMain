    ...
    <div class="row">
    	<div class="col-lg-12">
        	<p>        	
                ...
                <input type="text" class="w vp-form-control" id="video_width" value="600" /><br/>
                <label><?php _e( 'Height', 'viralpress' )?></label><br/>
                <input type="text" class="h vp-form-control" id="video_height" value="400" /><br/><br/>
    ...
    <div class="row">
    	<div class="col-lg-12">
        	<p>
                ...
                <label><?php _e( 'Width', 'viralpress' )?></label><br/>
                <input type="text" class="w vp-form-control" id="audio_width" value="600" /><br/>
                <label><?php _e( 'Height', 'viralpress' )?></label><br/>
                <input type="text" class="h vp-form-control" id="audio_height" value="800" /><br/><br/>
    ...
    <div class="row">
    	<div class="col-lg-12">
        	<p>
                ...
                <label><?php _e( 'Width', 'viralpress' )?></label><br/>
                <input type="text" class="w vp-form-control" id="pin_width" value="600" /><br/>
                <label><?php _e( 'Height', 'viralpress' )?></label><br/>
                <input type="text" class="h vp-form-control" id="pin_height" value="350" /><br/><br/>
