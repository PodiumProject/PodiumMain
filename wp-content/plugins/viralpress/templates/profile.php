		...
		<div class="row">
			<div class="col-lg-12">
				<div class="vp-cover" style="background:url(<?php echo $cover?>);color:white;">
                	<?php if($iedit): ?>
                	<div class="vp-pull-right" style="margin:10px">
                    	<i class="glyphicon glyphicon-edit vp-pointer edit-profile-images edit-cover"></i>
                    </div>
                    <?php endif;?>
					<div class="vp-avatar">
                    	<?php if($iedit): ?>
                    	<div style="position:absolute;margin-left:175px;margin-top:5px">
                            <i class="glyphicon glyphicon-edit vp-pointer edit-profile-images edit-avatar"></i>
                        </div>
                        <?php endif;?>
                    ...
                    <div class="vp-pull-right" style="margin-right:20px; margin-top:">
                ...
                <?php if( $noti_count ){?>
                <div class="alert alert-info"><?php _e( sprintf( 'You have %d new post(s) approved since your last visit to this page', $noti_count ) , 'viralpress' )?></div>
                <?php }?>
